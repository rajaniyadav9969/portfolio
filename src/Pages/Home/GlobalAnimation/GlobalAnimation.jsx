import s from "./GlobeAnimaton.module.scss";
...
const GlobeAnimaton = () => {
  ...
  React.useEffect(() => {
    ...
    animationRef.current = sphereAnimation();
    setTimeout(() => {
      //   sphereAnimation();
    }, 1000);
  }, []);
        ...
        for (var i = 0; i < pathLength; i++) {
          aimations.push(
            anime({
              ...
              stroke: {
                value:["rgb(0 ,53, 255,1)" ,"rgba(80,80,80,.85)"],  //stock color 
                duration: 1000,
              },
              translateX: [2, -4],
              translateY: [2, -4],
  ...
  return (
    <div className={`${s.container} globe-anim`}>
          ...
          <svg className="sphere" viewBox="0 0 440 440"  >
            <defs >
              ...
              >
                ...
                <stop stopColor="#e34545" offset="0%" />
                <stop stopColor="#e12424" offset="50%" />
                <stop stopColor="#e30505" offset="100%" />
              </linearGradient>
            </defs>
